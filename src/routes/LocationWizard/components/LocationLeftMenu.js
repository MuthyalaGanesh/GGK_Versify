...
var leftMenuHeight = w.innerHeight||e.clientHeight||g.clientHeight;
  ...
  return(   
          <aside className="main-sidebar control-sidebar-dark">
                  ...
                  <TypeaheadField searchLocationList ={props.searchLocationList} leftMenuDropdownClickEvent={(id,e)=>props.leftMenuDropdownClickEvent(id,e)}/>
                      <h5>Locations </h5>
