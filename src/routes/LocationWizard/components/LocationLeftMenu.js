                ...
                <ul className="sidebar-menu">                   
                    {props.Locations.map(location =>                      
                        <li className="treeview">
                         ...
                         <LocationLeftMenuChild key={location.id} name={location.Name} main-node={true} currentLocation={location} />
...
export const LocationLeftMenuChild =(props)=> {
         ...
         return(
          <ul className="treeview-menu">
                 ...
                 {props.currentLocation.Children.length > 0 
                  ? props.currentLocation.Children.map(child => <LocationLeftMenuChild key={child.id} name={child.Name} currentLocation={child}/>)
                  : ''
                  }
            </li>
         </ul> );
